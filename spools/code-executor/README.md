...
(runtime/module! runtime :millstrand/spools-code
  {:ns 'millstrand.spools.executors.code
   :spools ['millstrand.spools.executors/code
...
- [`millstrand.spools.workflow`](https://github.com/codethread/millstrand/blob/aed95c22bbdb1fe5a916886e8ebda787d370173d/spools/workflow.md) for gate authoring and executor registration.
- [`millstrand.spools.executors.shell`](../shell-executor/README.md) for process-isolated command execution.
