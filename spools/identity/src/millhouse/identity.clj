...
(def attribution-kind
  ...
  :millhouse.identity/attributions)
  ...
  (doto (registry/registry)
    (registry/declare-kind!
     {:id attribution-kind
      ...
      :candidate-validator
      'millhouse.identity/validate-attribution-contributions!})))
...
(defn open-attribution-engine!
  ...
  (events/register-handler!
   ...
   'millhouse.identity/on-attribution-event
   {:spool "identity"})
  (try
...
(lifecycle/defresource! attribution-engine
  ...
  {:open 'millhouse.identity/open-attribution-engine!
   :close 'millhouse.identity/close-attribution-engine!})
