...
-----
# <a name="millstrand.spools.chime">millstrand.spools.chime</a>
...
## <a name="millstrand.spools.chime/*runtime*">`*runtime*`</a>




Runtime captured for asynchronous notifier worker threads.
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L118-L120">Source</a></sub></p>

## <a name="millstrand.spools.chime/close-engine!">`close-engine!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L515-L550">Source</a></sub></p>

## <a name="millstrand.spools.chime/defrule">`defrule`</a>
``` clojure
...
Define a notification rule and collect its Chime declaration.
  ...
  override intent.
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L64-L81">Source</a></sub></p>

## <a name="millstrand.spools.chime/engine">`engine`</a>




Own Chime's handler, mutation barrier, and visible rule view atomically.
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L552-L555">Source</a></sub></p>

## <a name="millstrand.spools.chime/mutation-registration-barrier!">`mutation-registration-barrier!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L408-L414">Source</a></sub></p>

## <a name="millstrand.spools.chime/notifier">`notifier`</a>
``` clojure
(notifier)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L178-L181">Source</a></sub></p>

## <a name="millstrand.spools.chime/notify!">`notify!`</a>
``` clojure
(notify! notification)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L222-L238">Source</a></sub></p>

## <a name="millstrand.spools.chime/on-event">`on-event`</a>
``` clojure
(on-event event)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L403-L406">Source</a></sub></p>

## <a name="millstrand.spools.chime/open-engine!">`open-engine!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L489-L513">Source</a></sub></p>

## <a name="millstrand.spools.chime/recent-failures">`recent-failures`</a>
``` clojure
(recent-failures)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L135-L150">Source</a></sub></p>

## <a name="millstrand.spools.chime/register!">`register!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L256-L283">Source</a></sub></p>

## <a name="millstrand.spools.chime/reset-seen!">`reset-seen!`</a>
``` clojure
(reset-seen!)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L152-L157">Source</a></sub></p>

## <a name="millstrand.spools.chime/rule-declaration">`rule-declaration`</a>
``` clojure
...
Return a validated Chime rule declaration.
  ...
  metadata.
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L49-L62">Source</a></sub></p>

## <a name="millstrand.spools.chime/rule-kind">`rule-kind`</a>




Owner-partitioned kind id for Chime notification rules.
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L32-L34">Source</a></sub></p>

## <a name="millstrand.spools.chime/rules">`rules`</a>
``` clojure
(rules)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L285-L288">Source</a></sub></p>

## <a name="millstrand.spools.chime/scan!">`scan!`</a>
``` clojure
(scan! event)
(scan!)
```
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L382-L401">Source</a></sub></p>

## <a name="millstrand.spools.chime/set-notifier!">`set-notifier!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L168-L176">Source</a></sub></p>

## <a name="millstrand.spools.chime/unregister!">`unregister!`</a>
``` clojure
(unregister! name)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millstrand/spools/chime.clj#L290-L311">Source</a></sub></p>
