...
-----
# <a name="millhouse.chime">millhouse.chime</a>
...
## <a name="millhouse.chime/*runtime*">`*runtime*`</a>




Runtime captured for asynchronous notifier worker threads.
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L147-L149">Source</a></sub></p>

## <a name="millhouse.chime/close-engine!">`close-engine!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L571-L606">Source</a></sub></p>

## <a name="millhouse.chime/defrule">`defrule`</a>
``` clojure
(defrule & args)
```
Macro.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L109-L110">Source</a></sub></p>
...
## <a name="millhouse.chime/engine">`engine`</a>
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L608-L614">Source</a></sub></p>

## <a name="millhouse.chime/mutation-registration-barrier!">`mutation-registration-barrier!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L463-L470">Source</a></sub></p>

## <a name="millhouse.chime/notifier">`notifier`</a>
``` clojure
(notifier)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L208-L211">Source</a></sub></p>

## <a name="millhouse.chime/notify!">`notify!`</a>
``` clojure
(notify! notification)
```
Function.
...
Send one notification through the current binding.
  ...
  ```
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L252-L275">Source</a></sub></p>

## <a name="millhouse.chime/on-event">`on-event`</a>
``` clojure
(on-event event)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L453-L460">Source</a></sub></p>

## <a name="millhouse.chime/open-engine!">`open-engine!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L545-L569">Source</a></sub></p>

## <a name="millhouse.chime/recent-failures">`recent-failures`</a>
``` clojure
(recent-failures)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L164-L180">Source</a></sub></p>

## <a name="millhouse.chime/register!">`register!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L292-L330">Source</a></sub></p>

## <a name="millhouse.chime/reset-seen!">`reset-seen!`</a>
``` clojure
(reset-seen!)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L182-L187">Source</a></sub></p>

## <a name="millhouse.chime/rule-declaration">`rule-declaration`</a>
``` clojure
...
Return a validated Chime rule declaration.
  ...
  `use-rule!`.
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L67-L82">Source</a></sub></p>

## <a name="millhouse.chime/rule-kind">`rule-kind`</a>
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L38-L43">Source</a></sub></p>

## <a name="millhouse.chime/rules">`rules`</a>
``` clojure
(rules)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L332-L335">Source</a></sub></p>

## <a name="millhouse.chime/scan!">`scan!`</a>
``` clojure
(scan!)
(scan! event)
```
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L429-L451">Source</a></sub></p>

## <a name="millhouse.chime/set-notifier!">`set-notifier!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L189-L206">Source</a></sub></p>

## <a name="millhouse.chime/unregister!">`unregister!`</a>
``` clojure
(unregister! name)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/chime/src/millhouse/chime.clj#L337-L358">Source</a></sub></p>

## <a name="millhouse.chime/use-rule!">`use-rule!`</a>
``` clojure
(use-rule! & args)
```
Macro.
