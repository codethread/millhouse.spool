...
-----
# <a name="millstrand.spools.cron">millstrand.spools.cron</a>
...
## <a name="millstrand.spools.cron/actual-jobs">`actual-jobs`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L405-L409">Source</a></sub></p>

## <a name="millstrand.spools.cron/apply-jobs!">`apply-jobs!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L427-L442">Source</a></sub></p>

## <a name="millstrand.spools.cron/await-quiescent!">`await-quiescent!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L267-L295">Source</a></sub></p>

## <a name="millstrand.spools.cron/defjob">`defjob`</a>
``` clojure
(defjob id job)
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L377-L388">Source</a></sub></p>

## <a name="millstrand.spools.cron/desired-jobs">`desired-jobs`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L395-L403">Source</a></sub></p>

## <a name="millstrand.spools.cron/fire-wake">`fire-wake`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L237-L265">Source</a></sub></p>

## <a name="millstrand.spools.cron/job-declaration">`job-declaration`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L367-L375">Source</a></sub></p>

## <a name="millstrand.spools.cron/job-kind">`job-kind`</a>




Owner-partitioned kind id for Cron job declarations.
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L52-L54">Source</a></sub></p>

## <a name="millstrand.spools.cron/jobs">`jobs`</a>
``` clojure
(jobs runtime)
```
Function.
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L462-L470">Source</a></sub></p>

## <a name="millstrand.spools.cron/recent-failures">`recent-failures`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L124-L131">Source</a></sub></p>

## <a name="millstrand.spools.cron/register!">`register!`</a>
``` clojure
...
Register (or replace) a named cron job on `runtime` as a durable wake.
  ...
  - `:handler` — fully-qualified symbol resolving to `(fn [runtime] ..)`, invoked
    ...
    **Delta from `millstrand.api.scheduler.alpha/schedule!`'s `:handler`**, one layer
    ...
    scheduler's own `:handler` (always `millstrand.spools.cron/fire-wake`) on the
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L315-L365">Source</a></sub></p>

## <a name="millstrand.spools.cron/remove-jobs!">`remove-jobs!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L444-L452">Source</a></sub></p>

## <a name="millstrand.spools.cron/scheduled-jobs">`scheduled-jobs`</a>




Keep durable Cron wakes converged on the effective published job registry.
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L454-L460">Source</a></sub></p>

## <a name="millstrand.spools.cron/unregister!">`unregister!`</a>
``` clojure
...
<p><sub><a href="https://github.com/codethread/millhouse.spool/blob/main/spools/cron/src/millstrand/spools/cron.clj#L183-L203">Source</a></sub></p>
