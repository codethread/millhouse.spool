...
Composition recipes for `millhouse.spools.cron`: how to put spool-owned work on a
durable cadence, and why each shape is the right one.

This is the how/why half of the cron docs. The other two halves are:

- [`cron/README.md`](./README.md) — the contract: job shape, durable
...
(runtime/module! runtime :millhouse/spools-cron
  {:ns 'millhouse.spools.cron :spools ['millhouse.spools/cron]
   :required? true})
(runtime/module! runtime :report-job
  {:file "report_job.clj" :after [:millhouse/spools-cron]
   :required? true})
```
...
Honest source: this repo's [`.millstrand/jobs/nvd_scan.clj`](https://github.com/codethread/millstrand/blob/aed95c22bbdb1fe5a916886e8ebda787d370173d/.millstrand/jobs/nvd_scan.clj), wired
as `:nvd-scan` in [`.millstrand/init.clj`](https://github.com/codethread/millstrand/blob/aed95c22bbdb1fe5a916886e8ebda787d370173d/.millstrand/init.clj).
...
[`.millstrand/jobs/nvd_scan.clj`](https://github.com/codethread/millstrand/blob/aed95c22bbdb1fe5a916886e8ebda787d370173d/.millstrand/jobs/nvd_scan.clj) and its lock/finding tests in
[`test/millhouse/ct/nvd_scan_test.clj`](https://github.com/codethread/millstrand/blob/aed95c22bbdb1fe5a916886e8ebda787d370173d/test/millhouse/ct/nvd_scan_test.clj).
...
- [`cron/README.md`](./README.md) — the contract: job shape, cadence,
  delivery, status, and failure semantics.
- [`cron.api.md`](./cron.api.md) — generated signatures and docstrings for every
  fn referenced above.
- [`chime.cookbook.md`](../chime/chime.cookbook.md) — the sibling engine's recipes; cron
