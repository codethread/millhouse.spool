(ns millhouse.spools.workflow.internal.compile
  ...
  keywords stay qualified to `millhouse.spools.workflow` so `explain`/`s/explain-data`
...
(defn- require-valid-workflow! [workflow]
  (require-valid! :millhouse.spools.workflow/workflow workflow "Invalid workflow definition"))
...
(defn resolve-and-normalize
  ...
  (require-valid! :millhouse.spools.workflow.values/params params "Invalid workflow params")
...
(defn compile
  ...
  public `millhouse.spools.workflow/compile` exposes: `resolve-and-normalize` (the
