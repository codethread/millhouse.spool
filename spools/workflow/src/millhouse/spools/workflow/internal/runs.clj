(ns millhouse.spools.workflow.internal.runs
...
(defn result
  ...
  (let [root (root-view rt run-id)
    ...
    (util/require-shape! :millhouse.spools.workflow/run-result
                         {:operation operation
                          :run-id run-id
                          :root root
                          :ready ready
...
(defn attention-result
  ...
  (util/require-shape! :millhouse.spools.workflow/attention-result
