(ns millhouse.workflow.internal.compile
  ...
  keywords stay qualified to `millhouse.workflow` so `explain`/`s/explain-data`
...
(defn- require-valid-workflow! [workflow]
  (require-valid! :millhouse.workflow/workflow workflow "Invalid workflow definition"))
...
(defn resolve-and-normalize
  ...
  (require-valid! :millhouse.workflow.values/params params "Invalid workflow params")
...
(defn compile
  ...
  public `millhouse.workflow/compile` exposes: `resolve-and-normalize` (the
