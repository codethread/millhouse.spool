(ns millhouse.workflow.internal.discovery
  ...
  *declares* — its entry items, loops, gates, checkpoints, calls, defers, and the
  ...
  (:require [millhouse.workflow.internal.definitions :as defs]
            [millhouse.workflow.internal.registry :as registry]
            [millhouse.workflow.internal.specs :as specs]
            [millhouse.workflow.internal.util :as util :refer [require-shape!]]))
...
(defn- catalog-item
  ...
  [resolved]
  (require-shape! :millhouse.workflow/catalog-item
...
(defn catalog
  ...
  [rt request]
  (require-shape! :millhouse.workflow/list-request request
...
(defn definition-view
  ...
  repair it."
  [rt name]
  (require-shape! :millhouse.workflow/show-request {:workflow name}
  ...
  (let [resolved (defs/resolve-registered rt name)
    ...
    (require-shape! :millhouse.workflow/definition-view
