(ns millhouse.devflow
  ...
  plan, task queue, ...) lives in `millhouse.devflow.guidance` and is served
  ...
  (:require [camel-snake-kebab.core :as csk]
            [millhouse.devflow.guidance :as guidance]
            [millhouse.devflow.execution :as execution]
            [millhouse.devflow.cards :as cards]
            [millhouse.devflow.planning :as planning]
            [millhouse.devflow.internal.discovery :as discovery]
            [millhouse.devflow.internal.definition :as definition
  ...
  (workflow/workflow
    ...
    (workflow/checkpoint :handoff-card-review
                         ...
                         :choices [{:key :review
                                    ...
                                    :next 'millhouse.devflow.cards/review-cards
...
;;
;; The generic `millhouse.workflow` API owns starting, inspecting,
