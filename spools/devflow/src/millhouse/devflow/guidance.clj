(ns millhouse.devflow.guidance
  "Loader for the devflow authoring knowledge base.

  The knowledge itself lives as markdown under
  `resources/millhouse/devflow/guidance/`: one cohesive document per artifact
  ...
  guide with `millhouse.devflow/guidance` or `strand devflow guidance <key>`."
...
(defn- slurp-resource [file]
  (let [path (str "millhouse/devflow/guidance/" file)]
