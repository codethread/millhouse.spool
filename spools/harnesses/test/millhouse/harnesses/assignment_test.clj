(ns millhouse.harnesses.assignment-test
...
(def setup
  ...
  '(do
     (require '[clojure.string :as str]
              ...
              '[millhouse.harnesses.internal.assignment :as assignment-internal]
             ...
             (eval-world
              ...
              '(do
                 (require '[clojure.data.json :as json]
                          '[millhouse.harnesses.assignment.cli :as assign-cli])
