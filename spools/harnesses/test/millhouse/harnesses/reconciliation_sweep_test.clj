   ...
   {"modules/lifecycle_core.clj"
    "(ns modules.lifecycle-core
       (:require [millhouse.harnesses :as harnesses]
                 ...
                 [millhouse.harnesses.reconciliation :as reconcile]
    ...
    (fn [ctx]
      (let [result
            (test-alpha/repl!
             ctx
             '(do
                (require '[millhouse.harnesses.reconciliation :as reconcile]
                         '[millstrand.api.current.alpha :as current]
        ...
        (is (= 'millhouse.harnesses.reconciliation/sweep-wake!
               (:handler result)))
