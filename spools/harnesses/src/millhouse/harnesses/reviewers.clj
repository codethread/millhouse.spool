(ns millhouse.harnesses.reviewers
  ...
  (:require [clojure.spec.alpha :as s]
            ...
            [millhouse.harnesses.internal.registry :as harness-registry]
            [millhouse.harnesses.internal.review-git :as review-git]
...
(def ^:private kind :millhouse.harnesses.reviewers/reviewers)
(def ^:private state-key :millhouse.harnesses.reviewers/registry)
