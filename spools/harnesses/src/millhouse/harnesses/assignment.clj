(ns millhouse.harnesses.assignment
  ...
  (:require [clojure.spec.alpha :as s]
            ...
            [millhouse.harnesses.internal.assignment :as internal]
...
(s/def ::harness :millhouse.harnesses/name-ref)
(s/def ::target ::id)
...
(s/def ::resume-assigned-request
  (s/and
   (s/keys :opt-un [:millhouse.harnesses/prompt ::cwd
                    :millhouse.harnesses/attributes
                    :millhouse.harnesses/mode ::title ::by-identity
...
(s/fdef assign!
  :args (s/cat :runtime :millhouse.harnesses/runtime :request ::assign-request)
...
(defn- shipped-policy
  [policy-sym]
  (var-get (ns-resolve 'millhouse.harnesses.assignment policy-sym)))
...
(lifecycle/defresource assignment-runtime
  ...
  {:open 'millhouse.harnesses.assignment/open-assignment!
   :close 'millhouse.harnesses.assignment/close-assignment!
