...
(defn set-flag!
  ...
  (require-valid! :millhouse.harnesses/name-ref flag
...
(defn flag
  ...
  (require-valid! :millhouse.harnesses/name-ref flag-name
...
(defn register-harness!
  ...
  (require-valid! :millhouse.harnesses/name-ref harness-name
                  "register-harness! requires a harness name")
  (require-valid! :millhouse.harnesses/harness-definition definition
  ...
  (let [harness-name (registry/name-string harness-name "Harness name")
    ...
    (require-valid! :millhouse.harnesses/harness-registration
...
(s/fdef register-harness!
  :args (s/cat :runtime :millhouse.harnesses/runtime
               :harness-name :millhouse.harnesses/name-ref
               :definition :millhouse.harnesses/harness-definition)
  :ret :millhouse.harnesses/harness-registration)
...
(defn register-alias!
  ...
  (require-valid! :millhouse.harnesses/name-ref alias-name
                  "register-alias! requires an alias name")
  (require-valid! :millhouse.harnesses/alias-descriptor descriptor
  ...
  (let [alias-name (registry/name-string alias-name "Alias name")
    ...
    (require-valid! :millhouse.harnesses/alias-result
                    {:alias alias-name :candidates candidates}
                    "register-alias! produced an invalid registration")))

(s/fdef register-alias!
  :args (s/cat :runtime :millhouse.harnesses/runtime
               :alias-name :millhouse.harnesses/name-ref
               :descriptor :millhouse.harnesses/alias-descriptor)
  :ret :millhouse.harnesses/alias-result)
...
(defn resolve-harness
  ...
  (let [requested (registry/name-string requested "Harness")
    ...
    (let [layers (:layers result)
      ...
      (require-valid!
       :millhouse.harnesses/resolved-harness
       {:alias requested
...
(s/fdef resolve-harness
  :args (s/cat :runtime :millhouse.harnesses/runtime
               :requested :millhouse.harnesses/name-ref)
  :ret :millhouse.harnesses/resolved-harness)
...
(defn concrete-harness
  ...
  (require-valid!
   :millhouse.harnesses/harness-definition
...
(s/fdef concrete-harness
  :args (s/cat :runtime :millhouse.harnesses/runtime
               :harness-name :millhouse.harnesses/name-ref)
  :ret :millhouse.harnesses/harness-definition)
...
(defn harnesses
  ...
  ([rt requesting-alias]
   (require-valid! :millhouse.harnesses/runtime rt
                   "harnesses requires a Weaver runtime")
   (require-valid! :millhouse.harnesses/name-ref requesting-alias
...
(s/fdef harnesses
  :args (s/cat :runtime :millhouse.harnesses/runtime
               :requesting-alias (s/? :millhouse.harnesses/name-ref))
  :ret :millhouse.harnesses/registry-list)

(defn open-harness-core!
  "Open the provider-neutral harness registry for a module lifetime."
  [{:keys [runtime]}]
  (require-valid! :millhouse.harnesses/runtime runtime
...
(defn- registry-list [rt]
  (let [{:keys [harnesses aliases]} (registry-state rt)]
    (require-valid!
     :millhouse.harnesses/registry-list
     (vec
      (concat
