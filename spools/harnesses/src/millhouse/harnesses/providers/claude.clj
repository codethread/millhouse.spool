(ns millhouse.harnesses.providers.claude
  ...
  ([_rt attributes]
   ...
   (require-valid! ::harness/harness-definition
                   {:modes #{:headless :interactive}
                    :prepare 'millhouse.harnesses.providers.claude/prepare
                    :finish 'millhouse.harnesses.providers.claude/finish
...
(lifecycle/defresource claude-harness-runtime
  ...
  {:open 'millhouse.harnesses.providers.claude/open-claude-harness!
   :close 'millhouse.harnesses.providers.claude/close-claude-harness!
