(ns millhouse.harnesses.providers.codex
  ...
  ([_rt attributes]
   ...
   (require-valid! ::harness/harness-definition
                   {:modes #{:headless :interactive}
                    :prepare 'millhouse.harnesses.providers.codex/prepare
                    :finish 'millhouse.harnesses.providers.codex/finish
...
(lifecycle/defresource codex-harness-runtime
  ...
  {:open 'millhouse.harnesses.providers.codex/open-codex-harness!
   :close 'millhouse.harnesses.providers.codex/close-codex-harness!
