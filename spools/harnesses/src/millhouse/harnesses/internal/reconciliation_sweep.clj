(ns millhouse.harnesses.internal.reconciliation-sweep
...
(def ^:private state-key :millhouse.harnesses.reconciliation/state)
...
(def handler
  ...
  'millhouse.harnesses.reconciliation/sweep-wake!)
