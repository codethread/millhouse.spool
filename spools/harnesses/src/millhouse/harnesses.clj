(ns millhouse.harnesses
  ...
  (:require [clojure.spec.alpha :as s]
            ...
            [millhouse.harnesses.internal.guidance-receipts :as guidance-receipts]
            ...
            [millhouse.harnesses.internal.run-continuation :as continuation]
            [millhouse.harnesses.internal.run-creation :as creation]
            [millhouse.harnesses.internal.run-settlement :as settlement]
...
(lifecycle/defresource harness-core-runtime
  ...
  {:open 'millhouse.harnesses/open-harness-core!
   :close 'millhouse.harnesses/close-harness-core!})
