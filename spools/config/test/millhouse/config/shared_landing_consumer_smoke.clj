...
(defn- local-overrides [millhouse]
  {'millhouse/auto-run (local-root millhouse "spools/auto-run")
   'millhouse/workflow (local-root millhouse "spools/workflow")
   'millhouse/identity (local-root millhouse "spools/identity")
   'millhouse/kanban (local-root millhouse "spools/kanban")
   'millhouse/land (local-root millhouse "spools/land")
   'millhouse/harnesses (local-root millhouse "spools/harnesses")
   'millhouse/config (local-root millhouse "spools/config")
   'millhouse/devflow (local-root millhouse "spools/devflow")
   'millhouse/devflow-kanban-adapter
