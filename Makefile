...
KONDO_ROOTS := root millstrand auto-run chime cron identity kanban land workflow
...
kondo-import-auto-run kondo-import-chime kondo-import-cron kondo-import-identity kondo-import-kanban kondo-import-land kondo-import-workflow: kondo-import-%: check-clj-kondo
...
kondo-lint-auto-run kondo-lint-chime kondo-lint-cron kondo-lint-identity kondo-lint-kanban kondo-lint-land kondo-lint-workflow: kondo-lint-%: check-clj-kondo
...
lint-conventions: check-clj-kondo
	@$(RUN_CHECK) conventions sh -c '\
		...
		$(CLJ_KONDO) --repro \
			...
			--lint scripts test \
				spools/auto-run/src spools/chime/src spools/cron/src spools/kanban/src spools/land/src spools/workflow/src \
				.millstrand/init.clj \
