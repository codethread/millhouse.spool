...
| Spool                                                                                                   | Info                                                                                                                                         | Links                                                                                                                                                                                         |
| ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Auto-review](spools/auto-review/README.md) (`millhouse.spools/auto-review`) | Coordinate local, structured GitLab merge-request reviews with explicit curation and publication. | [contract](spools/auto-review/README.md) · [API](spools/auto-review/auto-review.api.md) |
