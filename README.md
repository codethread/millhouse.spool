...
| Spool                                                                                                   | Info                                                                                                                                         | Links                                                                                                                                                                                         |
| ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Auto-review](spools/auto-review/README.md) (`millhouse.spools/auto-review`) | Admit provider-neutral review revisions into Kanban, Auto-run and reviewer workflows. | [contract](spools/auto-review/README.md) · [API](spools/auto-review/auto-review.api.md) |
