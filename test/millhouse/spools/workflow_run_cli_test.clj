(ns millhouse.spools.workflow-run-cli-test
...
(defn- register!
  ...
  (doseq [name names]
    (workflow/register-workflow!
     name (symbol "millhouse.spools.workflow-run-cli-test" (clojure.core/name name)))))
...
(defn- module-source!
  ...
  (let [source (str "modules/" label ".clj")
    ...
    (spit file (str "(ns test.compose." label "\n"
                    ...
                    "  (:require [millhouse.spools.workflow :as workflow]" requires "))\n"
                    forms))
    source))
